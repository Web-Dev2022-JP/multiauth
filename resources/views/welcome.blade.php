@extends('layouts.nav')
@extends('layouts_resources.modal')
@extends('layouts_resources.signup')
@extends('layouts_resources.frequently')
            ...
            <div class="col-sm-3 van-col">
                <div class="card van-card">
                    ...
                    <div class="col-sm-8 mb-3" style="margin: auto">
                        <input class="btn btn-secondary form-control" type="button" value="View Details">
                    </div>
                </div>
            </div>
            <div class="col-sm-3 van-col">
